...
public class TestMaterials {
    ...
    public static void init() {
        ...
        LocalMaterials.BUSH = TestMaterialData.nonSolid("minecraft:bush");
        LocalMaterials.LEAF_LITTER = TestMaterialData.nonSolid("minecraft:leaf_litter");
        LocalMaterials.CACTUS_FLOWER = TestMaterialData.nonSolid("minecraft:cactus_flower");
        LocalMaterials.FIREFLY_BUSH = TestMaterialData.nonSolid("minecraft:firefly_bush");
        LocalMaterials.WILDFLOWERS = TestMaterialData.nonSolid("minecraft:wildflowers");
        LocalMaterials.SHORT_DRY_GRASS = TestMaterialData.nonSolid("minecraft:short_dry_grass");
        LocalMaterials.TALL_DRY_GRASS = TestMaterialData.nonSolid("minecraft:tall_dry_grass");
        LocalMaterials.PALE_MOSS_BLOCK = TestMaterialData.solid("minecraft:pale_moss_block");
        LocalMaterials.PALE_MOSS_CARPET = TestMaterialData.nonSolid("minecraft:pale_moss_carpet");
        LocalMaterials.PALE_HANGING_MOSS = TestMaterialData.nonSolid("minecraft:pale_hanging_moss");
