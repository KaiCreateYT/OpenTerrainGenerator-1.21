...
public class PlantType
{
	...
	public static final PlantType Bush = register(new PlantType("Bush", LocalMaterials.BUSH));
	public static final PlantType FireflyBush = register(new PlantType("FireflyBush", LocalMaterials.FIREFLY_BUSH));
	public static final PlantType Wildflowers = register(new PlantType("Wildflowers", LocalMaterials.WILDFLOWERS));
