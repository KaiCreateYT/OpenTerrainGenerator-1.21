...
class BO3Settings extends Settings
{
	...
	static final Setting<Integer>
		...
		MIN_HEIGHT = intSetting("MinHeight", 0, Constants.WORLD_START_MIN_Y, Constants.WORLD_END_MAX_Y),
		MAX_HEIGHT = intSetting("MaxHeight", 256, Constants.WORLD_START_MIN_Y, Constants.WORLD_END_MAX_Y),
