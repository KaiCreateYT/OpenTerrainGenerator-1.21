...
public final class Viewport3DRenderer {
    ...
    public static void render(GuiGraphics graphics, int vpX, int vpY, int vpW, int vpH,
        ...
        // RenderSystem.viewport(fbX, fbY, fbW, fbH); // removed in 1.21.5
        ...
        // RenderSystem.enableDepthTest(); // removed in 1.21.5
        // RenderSystem.depthMask(true); // removed in 1.21.5
        ...
        // Translucent pass
        // RenderSystem.enableBlend(); // removed in 1.21.5
        // RenderSystem.depthMask(false); // removed in 1.21.5
        renderer.draw(RenderType.translucent(), viewMatrix, projMatrix);
        // RenderSystem.depthMask(true); // removed in 1.21.5
        // RenderSystem.disableBlend(); // removed in 1.21.5

        // Restore depth test and viewport for GUI rendering
        // RenderSystem.disableDepthTest(); // removed in 1.21.5
        // RenderSystem.viewport(0, 0, window.getWidth(), window.getHeight()); // removed in 1.21.5
