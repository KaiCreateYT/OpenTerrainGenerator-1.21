...
/**
 * Abstract base for platform NBT helpers. Contains all the NMS<->OTG NBT
...
public class SharedNBTHelper extends LocalNBTHelper {
    ...
    private static NamedBinaryTag getNBTFromNMSTagList(String name, ListTag nmsListTag)
    {
        ...
        NamedBinaryTag.Type listType = NamedBinaryTag.Type.values()[nmsListTag.get(0).getId()];
    ...
    public static NamedBinaryTag getNBTFromNMSTagCompound(String name, CompoundTag nmsCompoundTag) {
        ...
        Set<String> keys = nmsCompoundTag.keySet();
    ...
    private static Object getValueFromNms(Tag inbt)
    {
        ...
        return switch (type) {
            case TAG_Byte -> ((net.minecraft.nbt.NumericTag) inbt).byteValue();
            case TAG_Short -> ((net.minecraft.nbt.NumericTag) inbt).shortValue();
            case TAG_Int -> ((net.minecraft.nbt.NumericTag) inbt).intValue();
            case TAG_Long -> ((net.minecraft.nbt.NumericTag) inbt).longValue();
            case TAG_Float -> ((net.minecraft.nbt.NumericTag) inbt).floatValue();
            case TAG_Double -> ((net.minecraft.nbt.NumericTag) inbt).doubleValue();
            case TAG_Byte_Array -> ((ByteArrayTag) inbt).getAsByteArray();
            case TAG_String -> ((StringTag) inbt).value();
