...
public class OTGNoiseRouterData {
    ...
    public static DensityFunction caveDensityForCarving(
        ...
        DensityFunction cheese = DensityFunctions.add(DensityFunctions.constant(0.27), caveCheeseNoise).clamp(-1.0, 1.0);
        ...
        // Surface suppression (none currently in noise router, handled externally)
