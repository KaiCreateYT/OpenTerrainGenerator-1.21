...
@Getter
public class NeoForgeMaterialTag extends LocalMaterialTag {
    private final TagKey<Block> key;
    public NeoForgeMaterialTag(TagKey<Block> key, String name) {
        super(name);
        this.key = key;
    }
    ...
    public static LocalMaterialTag ofString(String tag) {
        ...
        return new NeoForgeMaterialTag(tagKey, tag);
    }
