...
public class LegacyNeoForgeBiomeLoader extends LocalPresetLoader {
    ...
    private void registerBiomesForPreset(Preset preset, WritableRegistry<Biome> biomeRegistry)
    {
        ...
        for(Entry<IBiomeResourceLocation, BiomeSettings> biomeSettingsEntry : biomeConfigsByResourceLocation.entrySet())
        {
            ...
            if(
                ...
                biome = LegacyNeoForgeBiomeLoader.createOTGBiome(preset.getPresetConfig(), biomeConfig, featureHolder, carverHolder);
            ...
            //OTGClientSyncManager.getSyncedData().put(resourceLocation.toString(), new NeoForgeBiomeSyncWrapper(biomeSettings));
            ...
            IBiome otgBiome = new NeoForgeBiome(biomeSettings, biome, ref);
            ...
            if (!includeTags.isEmpty()) {
                for (ResourceKey<Biome> biomeKey : biomeRegistry.registryKeySet()) {
                    ...
                    for (String includeTag : includeTags) {
                        if (!NeoForgeBiomeTagMapper.biomeHasTag(biomeRegistry, biomeKey, includeTag)) {
                    ...
                    for (String excludeTag : excludeTags) {
                        if (NeoForgeBiomeTagMapper.biomeHasTag(biomeRegistry, biomeKey, excludeTag)) {
