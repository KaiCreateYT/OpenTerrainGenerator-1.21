...
public class NeoForgeMaterialReader implements IMaterialReader {
    ...
    public LocalMaterialTag readTag(String tag) throws InvalidConfigException {
        ...
        localTag = NeoForgeMaterialTag.ofString(tag);
    ...
    private LocalMaterialData materialFromString(String input) throws InvalidConfigException
    {
        ...
        {
            return NeoForgeMaterialData.getBlank();
        }
        ...
        {
            blockState = NeoForgeLegacyMaterials.fromLegacyBlockName(blockNameCorrected);
            if(blockState != null)
            {
                return NeoForgeMaterialData.ofBlockState(blockState, input);
            }
            try
            {
        ...
        if(state != null)
        {
            ...
            {
                return NeoForgeMaterialData.ofBlockState(state.setValue(LeavesBlock.DISTANCE, 1), input);
            }
            return NeoForgeMaterialData.ofBlockState(state, input);
        }
        ...
        if(blockNameCorrected.contains(":"))
        {
            ...
            try
            {
                ...
                blockState = NeoForgeLegacyMaterials.fromLegacyBlockNameOrIdWithData(blockNameOrId, data);
                if(blockState != null)
                {
                    return NeoForgeMaterialData.ofBlockState(blockState, input);
                }
        ...
        try
        {
            ...
            if(block != null && (block != Blocks.AIR || blockNameCorrected.toLowerCase().endsWith("air")))
            {
                ...
                {
                    return NeoForgeMaterialData.ofBlockState(block.defaultBlockState().setValue(LeavesBlock.DISTANCE, 1), input);
                }
                return NeoForgeMaterialData.ofBlock(block, input);
            }
        } catch(ResourceLocationException ignored) { }

        // Try legacy name again, without data.
        blockState = NeoForgeLegacyMaterials.fromLegacyBlockName(blockNameCorrected.replace("minecraft:", ""));
        if(blockState != null)
        {
            return NeoForgeMaterialData.ofBlockState(blockState, input);
        }
        ...
        return NeoForgeMaterialData.ofBlock(Blocks.AIR, input);
    }
}
