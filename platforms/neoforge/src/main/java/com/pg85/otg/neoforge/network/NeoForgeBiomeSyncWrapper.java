package com.pg85.otg.neoforge.network;
...
@Getter
public class NeoForgeBiomeSyncWrapper {
    ...
    public NeoForgeBiomeSyncWrapper(BiomeSettings config)
    {
    ...
    public NeoForgeBiomeSyncWrapper(FriendlyByteBuf buffer)
    {
