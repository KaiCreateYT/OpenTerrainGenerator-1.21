...
public class NeoForgeDimensionManager {

    private final NeoForgeDimensionHelper helper;
    private DimensionStorage storage;
    private DimensionDatapack datapack;
    private MinecraftServer server;

    public NeoForgeDimensionManager() {
        this.helper = new NeoForgeDimensionHelper();
    }
    ...
    public NeoForgeDimensionHelper getHelper() {
        return helper;
    }
